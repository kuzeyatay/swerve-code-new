  ...
  public ModuleIOSparkMax(int index) {
    switch (index) {
      case 0:
        ...
        absoluteEncoderOffset = new Rotation2d(-0.379); // MUST BE CALIBRATED
        break;
      case 1:
        driveSparkMax = new CANSparkMax(1, MotorType.kBrushless);
        turnSparkMax = new CANSparkMax(2, MotorType.kBrushless);
        cancoder = new CANcoder(9);
        absoluteEncoderOffset = new Rotation2d(-2.425); // MUST BE CALIBRATED
        break;
      case 2:
      ...
      case 3:
        ...
        absoluteEncoderOffset = new Rotation2d(0.933); // MUST BE CALIBRATED
        break;
      default:
